...
<div class="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
  <div class="flex items-center justify-between px-5 py-4 border-b border-gray-800">
    <h3 class="text-sm font-medium text-gray-300">All Roles</h3>
    ...
    <table class="w-full text-sm">
      <thead>
        <tr class="border-b border-gray-800">
          ...
          <th class="text-left px-5 py-3 text-xs text-gray-600 font-medium uppercase tracking-wider">Permissions</th>
          <th class="text-left px-5 py-3 text-xs text-gray-600 font-medium uppercase tracking-wider">Users</th>
      ...
      <tbody class="divide-y divide-gray-800">
        ...
        <tr class="hover:bg-gray-800/40 transition-colors">
          <td class="px-5 py-3.5">
            <span class="text-gray-300 font-medium">{{ ucfirst($role->name) }}</span>
          </td>
          <td class="px-5 py-3.5">
          ...
          <td class="px-5 py-3.5 text-gray-500">{{ $role->users_count }}</td>
          <td class="px-5 py-3.5">
